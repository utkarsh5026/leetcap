...
2. If the user passed extra text after invoking this command, treat it as optional focus (paths, feature name, or ticket); weight those changes more heavily in the message.
