...
2. Base branch: if the user named a branch (e.g. `main`, `master`), mention what you compared when relevant; otherwise assume the diff is the full change set to ship.
